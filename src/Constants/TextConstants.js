...
export const components = {
  ...
  TICKETMOB: 'TICKETMOB',
  PROFILEMOB:'PROFILEMOB',
  ADDTICKET_MOB:'ADDTICKET_MOB',
  DASHBOARD_MOB:'DASHBOARD_MOB',
  NOTIFICATION_MOB:'NOTIFICATION_MOB',
  VIEWTICKET_MOB:'VIEWTICKET_MOB',
  USERS_MOB:'USERS_MOB',
  EDIT_USER_MOB:'EDIT_USER_MOB',
  CREATE_USER_MOB:'CREATE_USER_MOB'
};
