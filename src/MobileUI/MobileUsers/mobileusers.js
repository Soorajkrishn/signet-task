    ...
    return (
        <>
            ...
            <div className="wrapperBase">
                <ul>
                    {sliceTicket.map((v) => <li className="userList" key={v.userId}>
                        <p><b>Name         : </b>{v.firstName} {v.lastName}</p>
                        <p><b>Status       : </b>{v.status}</p>
                        <p><b>Mobile       : </b>{v.mobileNumber}</p>
                        <p><b>Organization : </b>{v.organization}</p></li>)}
                </ul>
                <div>
