        ...
        <>
            ...
            <div className="container">
                <Form noValidate validated={validated} className="fromWrap">
                    ...
                    {test.profileEdit ? <div className="d-flex  align-items-start w-100 customVerifyBox">
                    ...
                    <label><b>Organization Emil</b></label>
                    {test.profileEdit ? (
                ...
                {test.profileEdit && <div className="profileButtons">
