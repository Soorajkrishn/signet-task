            ...
            <>
              <Row>
                ...
                <div className="cardWrapper">
                  ...
                  <h5>Number of Users : <b>{totalUsers}</b></h5>
                  </div>
                </Col>
                <Col lg={4} md={12} sm={12} xs={12}>
                <div className="cardWrapper">
                ...
                <div className="cardWrapper">
                  ...
                  <h5>Number of Organization : <b>{registeredOrg.length}</b></h5>
                  </div>
                </Col>
              </Row>
              <Row className="mt-3">
              ...
              <Table bordered className="tableBackground">
                    ...
                    <tbody>
                      {registeredOrg.map((v) => <tr key={v.organization} onClick={()=>setOrg(v.organization)}><td >{v.organization!==null? v.organization:'Others'}</td></tr>)}
                    </tbody>
                  </Table>
              </Col>
              ...
              <Table bordered className="tableBackground">
                ...
                {filterUsers.map((v)=><tbody>
                  <tr key={v.userId}>
                    <td><Button variant="link" onClick={()=>handleClick(v.userId)}>{v.firstName}</Button></td>
