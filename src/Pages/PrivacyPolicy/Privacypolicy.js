...
function Privacypolicy() {
  return (
    <div className="container contentWrapper">
      ...
      <br />
      <p>
        Your use of www.SIGNET.com and the SIGNET Mobile App is subject to SIGNET Privacy Policy Please review our Privacy Policy,
      ...
      <p>
        Visiting www.signetgroup.net, using the mobile app, or sending emails to SIGNET constitutes electronic communications. You
      ...
      <p>
        If you use this site or Mobile application, you are responsible for maintaining the confidentiality of your account and
        password and for restricting access to your computer, and you agree to accept responsibility for all activities that occur
        under your account or password. You may not assign or otherwise transfer your account to any other person or entity. You
        acknowledge that SIGNET is not responsible for third party access to your account that results from theft or
        misappropriation of your account. SIGNET and its associates reserve the right to refuse or cancel service, terminate
      ...
      <p>
        ...
        If you are under 18, you may use www.signetgroup.net or the SIGNET mobile app only with permission of a parent or
        guardian.
      </p>
      <br />
      ...
      <p>
        www.signetgroup.net and the SIGNET mobile app may contain links to other websites (Linked Sites). The Linked Sites are not
      ...
      <p>
        Certain services made available via www.SIGNET.com are delivered by third party sites and organizations. By using any
        product, service or functionality originating from the www.SIGNET.com domain, you hereby acknowledge and consent that
        ...
        the requested product, service, or functionality on behalf of www.signetgroup.net users and customers.
      </p>
      <br />
      ...
      <p>
        You are granted a non-exclusive, non-transferable, revocable license to access and use www.signetgroup.net and the SIGNET
      ...
      <p>
        ...
        and any software used on the Site, is the property of SIGNET or its suppliers and protected by copyright and other laws
      ...
      <p>
        ...
        in any way exploit any of the content, in whole or in part, found on the Site. SIGNET content is not for resale. Your use
        ...
        your personal use and will make no other use of the content without the express written permission of SIGNET and the
        copyright owner. You agree that you do not acquire any ownership rights in any protected content. We do not grant you any
        licenses, express or implied, to the intellectual property of SIGNET or our licensors except as expressly authorized by
        these Terms.
      </p>
      <br />
      ...
      <p>
        ...
        through www.signetgroup.net and the SIGNET mobile app in any country outside of the USA or in any manner prohibited by any
      ...
      <p>
        You agree to indemnify, defend and hold harmless SIGNET, its officers, directors, employees, agents and third parties, for
        any losses, costs, liabilities and expenses (including reasonable attorneys fees) relating to or arising out of your use
        of or inability to use the Site or services, any user postings made by you, your violation of any terms of this Agreement
        or your violation of any rights of a third party, or your violation of any applicable laws, rules or regulations. SIGNET
        reserves the right, at its own cost, to assume the exclusive defense and control of any matter otherwise subject to
        indemnification by you, in which event you will fully cooperate with SIGNET in asserting any available defenses.
      </p>
      <br />
      ...
      <p>
        ...
        arbitration service selected by the parties, in a location mutually agreed upon by the parties. The arbitrators award
        ...
        shall be entitled to recover its costs and reasonable attorneys fees. The parties agree to arbitrate all disputes and
        claims in regard to these Terms and Conditions or any disputes arising as a result of these Terms and Conditions, whether
      ...
      <p>
        ...
        OTHER ONLY IN EACH INDIVIDUAL CAPACITY, AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PUTATIVE CLASS, COLLECTIVE AND/ OR
        REPRESENTATIVE PROCEEDING, SUCH AS IN THE FORM OF A PRIVATE ATTORNEY GENERAL ACTION AGAINST THE OTHER. Further, unless
        both you and SIGNET agree otherwise, the arbitrator may not consolidate more than one persons claims and may not otherwise
      ...
      <p>
        ...
        TYPOGRAPHICAL ERRORS. CHANGES ARE PERIODICALLY ADDED TO THE INFORMATION HEREIN. SIGNET, INC. AND/OR ITS SUPPLIERS MAY MAKE
        IMPROVEMENTS AND/OR CHANGES IN THE SITE AT ANY TIME.
      </p>
      <br />

      <p>
        SIGNET, INC. AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE SUITABILITY, RELIABILITY, AVAILABILITY, TIMELINESS,
        ...
        ARE PROVIDED AS IS WITHOUT WARRANTY OR CONDITION OF ANY KIND. SIGNET, INC. AND/OR ITS SUPPLIERS HEREBY DISCLAIM ALL
        WARRANTIES AND CONDITIONS WITH REGARD TO THIS INFORMATION, SOFTWARE, PRODUCTS, SERVICES AND RELATED GRAPHICS, INCLUDING
        ALL IMPLIED WARRANTIES OR CONDITIONS OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE AND NON-INFRINGEMENT.
      </p>
      <br />

      <p>
        TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL SIGNET, INC. AND/OR ITS SUPPLIERS BE LIABLE FOR ANY
        ...
        OTHERWISE ARISING OUT OF THE USE OF THE SITE, WHETHER BASED ON CONTRACT, TORT, NEGLIGENCE, STRICT LIABILITY OR OTHERWISE,
        EVEN IF SIGNET, INC. OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE POSSIBILITY OF DAMAGES. BECAUSE SOME
        STATES/JURISDICTIONS DO NOT ALLOW THE EXCLUSION OR LIMITATION OF LIABILITY FOR CONSEQUENTIAL OR INCIDENTAL DAMAGES, THE
        ABOVE LIMITATION MAY NOT APPLY TO YOU. IF YOU ARE DISSATISFIED WITH ANY PORTION OF THE SITE, OR WITH ANY OF THESE TERMS OF
      ...
      <p>
        SIGNET reserves the right, in its sole discretion, to terminate your access to the Site and the related services or any
        portion thereof at any time, without notice. To the maximum extent permitted by law, this agreement is governed by the
        laws of the State of Massachusetts, and you hereby consent to the exclusive jurisdiction and venue of courts in Maine in
      ...
      <p>
        You agree that no joint venture, partnership, employment, or agency relationship exists between you and SIGNET as a result
        of this agreement or use of the Site. SIGNETs performance of this agreement is subject to existing laws and legal process,
        and nothing contained in this agreement is in derogation of SIGNETs right to comply with governmental, court and law
        enforcement requests or requirements relating to your use of the Site or information provided to or gathered by SIGNET
        with respect to such use. If any part of this agreement is determined to be invalid or unenforceable pursuant to
      ...
      <p>
        ...
        or written, between the user and SIGNET with respect to the Site. A printed version of this agreement and of any notice
        given in electronic form shall be admissible in judicial or administrative proceedings based upon or relating to this
      ...
      <p>
        SIGNET reserves the right, in its sole discretion, to change the Terms under which www.signetgroup.net and the SIGNET
      ...
      <p>Contact https://signetgroup.net/contact-us/?subject=General+Information</p>
      <br />
      <p>Mail: SIGNET, Inc.</p>
      <br />
      <p>Corporate Headquarters</p>
      <br />
      <p>SIGNET Electronic Systems, Inc.</p>
      <br />
      <p>90 Longwater Drive</p>
      <br />
      <p>Norwell, MA 02061</p>
      <br />
      <p>Phone: 781-871-5888</p>
      <br />
      <p>Fax: 781-871-4757</p>
      <br />
      <p>Effective as of June 01, 2022</p>
      <br />
    </div>
  );
}
